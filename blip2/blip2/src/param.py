...
def parse_args():
    ...
    parser.add_argument('--loadBLIP2', dest='load_lxmert', type=str, default=None,
                        help='Load the pre-trained BLIP2 model.')
    parser.add_argument('--loadBLIP2QA', dest='load_lxmert_qa', type=str, default=None,
                        help='Load the pre-trained BLIP2 model with QA answer head.')
    parser.add_argument("--fromScratch", dest='from_scratch', action='store_const', default=False, const=True,
                        help='If none of the --load, --loadBLIP2, --loadBLIP2QA is set, '
